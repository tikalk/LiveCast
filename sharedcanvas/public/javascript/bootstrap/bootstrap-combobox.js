...
!function( $ ) {
 ...
 "use strict"
  ...
  template: '<div class="combobox-container fix"><input id="search-input" type="text" /><span class="add-on btn dropdown-toggle" data-dropdown="dropdown"><span class="caret"/><span class="combobox-clear"><i class="icon-remove"/></span></span></div>'
